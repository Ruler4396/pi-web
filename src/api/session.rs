...
pub async fn models(State(state): State<AppState>) -> Result<Json<serde_json::Value>, StatusCode> {
    let builtin = vec![
        serde_json::json!({"provider": "deepseek", "id": "deepseek-v4-flash", "label": "DeepSeek V4 Flash", "thinking": true, "builtin": true, "thinkingLevels": ["off","low","medium","high","max"], "contextLimit": 1048576}),
        serde_json::json!({"provider": "deepseek", "id": "deepseek-v4-pro", "label": "DeepSeek V4 Pro", "thinking": true, "builtin": true, "thinkingLevels": ["off","low","medium","high","max"], "contextLimit": 1048576}),
    ];
